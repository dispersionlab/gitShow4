...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 31.0, 152.0, 91.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 74.215164184570312, 449.0, 105.0, 60.0 ],
					"text" : "Scale and add modulator signal to carrier frequency for FM",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.0, 630.5, 66.0, 29.0 ],
					"text" : "MC Signal out ",
					"textcolor" : [ 0.129411771893501, 0.129411771893501, 0.129411771893501, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 166.0, 79.0, 66.0, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 154.0, 552.0, 78.0, 20.0 ],
					"text" : "< Carrier"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 184.0, 152.0, 73.5, 22.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.0, 79.0, 66.0, 18.0 ],
					"text" : "Wave Msgs",
					"textcolor" : [ 0.129411771893501, 0.129411771893501, 0.129411771893501, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 238.5, 374.5, 78.0, 49.0 ],
					"text" : "mc.*~ @bzname #2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 238.5, 298.5, 78.0, 49.0 ],
					"text" : "mc.*~ @bzname #2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 184.0, 449.0, 145.0, 22.0 ],
					"text" : "mc.+~ @bzname #2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 184.0, 489.5, 174.0, 22.0 ],
					"text" : "mc.phasor~ @bzname #2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 31.0, 544.5, 111.0, 35.0 ],
					"text" : "mc.wave~ @bzname #2",
					"textcolor" : [ 0.968627452850342, 0.968627452850342, 0.968627452850342, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 31.0, 110.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 31.0, 598.5, 30.0, 30.0 ]
				}
